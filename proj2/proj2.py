...
CPU_Load_02 = FuzzySet( points=[[0.50, 1.],  [0.70, 1.],  [0.80, 1], [0.90, 0]], term="good_load" )
...
CPU_Mem_02 = FuzzySet( points=[[0.45, 1.],  [0.65, 1.],  [0.75, 1], [0.85, 0]], term="medium_memory" )
...
CPU_Fs_02 = FuzzySet( points=[[0.25, 1.],  [0.40, 1.],  [0.60, 1], [0.75, 0]], term="medium_cpu_fs" )
CPU_Fs_03 = FuzzySet( points=[[0.60, 0.],  [0.75, 1.], [1, 1]], term="high_cpu_fs" )

FS_CPU.add_linguistic_variable("cpu_fs", LinguisticVariable( [CPU_Fs_01, CPU_Mem_02, CPU_Mem_03] ))
