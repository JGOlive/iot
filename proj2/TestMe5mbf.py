...
Template_OUT_Small_01 = FuzzySet(points=[[0, 0], [0, 1.], [0.1, 1.], [0.2, 0]], term="low")
Template_OUT_Small_02 = FuzzySet(points=[[0.10, 0], [0.25, 1.], [0.35, 1.], [0.45, 0]], term="medium-low")
Template_OUT_Small_03 = FuzzySet(points=[[0.35, 0.], [0.45, 1.], [0.55, 1.], [0.65, 0]], term="medium")
Template_OUT_Small_04 = FuzzySet(points=[[0.55, 0], [0.65, 1.], [0.75, 1.], [0.90, 0]], term="medium-high")
Template_OUT_Small_05 = FuzzySet(points=[[0.80, 0.], [0.90, 1.], [1, 1.], [1, 0]], term="high")

Template_OUT = [Template_OUT_Small_01, Template_OUT_Small_02, Template_OUT_Small_03, Template_OUT_Small_04, Template_OUT_Small_05]
'''
...
CPU_LOAD.add_linguistic_variable("cpu_load", LinguisticVariable( Template_OUT, universe_of_discourse=[0,1] ))
...
FS_NET_US.add_linguistic_variable("net_us_fs", LinguisticVariable( Template_OUT, universe_of_discourse=[0,1]))
...
FS_NET_AV.add_linguistic_variable("net_av_fs", LinguisticVariable( Template_OUT, universe_of_discourse=[0,1] ))
...
FS_CLPV.add_linguistic_variable("clpv", LinguisticVariable( Template_OUT_Big, universe_of_discourse=[-1,1] ))
